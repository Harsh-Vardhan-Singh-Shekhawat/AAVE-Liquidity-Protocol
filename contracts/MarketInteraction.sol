...
contract MarketInteraction {
    ...
    address private immutable alinkAddress = 0x6A639d29454287B3cBB632Aa9f93bfB89E3fd18f;
    IERC20 private link;
    ...
    function supplyLiquidity(address _tokenAddress, uint256 _amount) external {
            ...
            POOL.supply(asset, amount, onBehalfOf, referalCode);
    }
    ...
    function getUserAccountData(address _userAddress ) view external returns(uint256 totalCollateralBase,uint256 totalDebtBase,uint256 availableBorrowsBase,uint256 currentLiquidationThreshold,uint256 ltv,uint256 healthFactor) {
